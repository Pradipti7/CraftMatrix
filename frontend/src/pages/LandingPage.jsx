...
export default function CraftMatrixLanding({ onStartCreating, onPatterns, onHome, showGrid = false }) {
  ...
  return (
    <div style={{ position: "relative", width: "100%", minHeight: "100vh", overflow: "hidden", backgroundColor: INK, fontFamily: "'Inter', system-ui, sans-serif" }}>
      <div style={{ position: "relative", zIndex: 200 }}>
        <Navbar onStartCreating={onStartCreating} onPatterns={onPatterns} onHome={onHome} />
      </div>
      <div style={{ position: "relative", width: "100%", minHeight: "100vh", overflow: "hidden", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px", paddingTop: "80px" }}>
        ...
        <div style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", maxWidth: 768 }}>
          ...
          {ready && (
            <button
              ...
              style={{
                position: "relative", marginTop: 40, padding: "16px 36px",
        ...
        {ready && showGrid && <GridControls cols={cols} rows={rows} onColsChange={setCols} onRowsChange={setRows} />}
      </div>
    </div>
  );
}
